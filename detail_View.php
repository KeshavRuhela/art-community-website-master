                ...
                <div style="width:45%;  overflow-y: overlay; padding:5px; height:100%; margin:auto; border:1px solid black;">
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="font-weight:1000; font-size: 1.5rem;">₹<small style="font-weight:1000;font-size: 1rem;" class="text">' . $all[count($all) - 1][3] . '</small> <a class="custom-option" onclick="like_it()" id="like_it">🤍</a><a class="custom-option" onclick="buy_it()" id="like_it">🛒</a></p>
